...
import * as sty from "./PlasmicHeader.module.css"; // plasmic-import: SpQrDSfZy-T/css
...
function PlasmicHeader__RenderFunc(props) {
  ...
  return (
    ...
    >
      ...
      >
        <LogoIcon
          className={classNames(defaultcss.all, projectcss.all, sty.svg__xyrpF)}
          role={"img"}
        />
      </p.PlasmicLink>
      ...
      >
        <Button
          className={classNames("__wab_instance", sty.button__smBp5)}
          color={"clear"}
          link={"/features"}
          size={"compact"}
        >
        ...
        <Button
          className={classNames("__wab_instance", sty.button__pYw8Z)}
          color={"clear"}
          link={"/pricing"}
          size={"compact"}
        >
        ...
        <Button
          className={classNames("__wab_instance", sty.button__to2Wx)}
          color={"clear"}
          size={"compact"}
        >
          {"Sign in"}
        ...
        {(hasVariant(globalVariants, "screen", "mobile") ? true : true) ? (
          <Button
            className={classNames("__wab_instance", sty.button__cKuA8)}
            endIcon={
              <RightArrowIcon
                className={classNames(
                  defaultcss.all,
