...
import * as sty from "./PlasmicBaseCard.module.css"; // plasmic-import: 70pRqKwjwyda/css
    ...
    >
      <div
        className={classNames(
          ...
          sty.freeBox__x8Olu,
          {
            [sty.freeBox__long__x8OluMdQr]: hasVariant(variants, "long", "long")
          }
        )}
      >
        {p.renderPlasmicSlot({
      ...
      {(hasVariant(variants, "long", "long") ? true : true) ? (
        <div
          className={classNames(
            ...
            sty.freeBox__jxc9U,
            {
              [sty.freeBox__long__jxc9UMdQr]: hasVariant(
                variants,
                "long",
                "long"
              )
